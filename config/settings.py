...
class Settings(BaseSettings):
    ...
    elevenlabs_voice_id: str = ""  # Leave blank for auto topic-based voice selection
    elevenlabs_model_id: str = "eleven_multilingual_v2"  # Best for Hindi/Hinglish content
